...
public class MarkingImpl extends ObjectAnnotationImpl implements Marking {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TextualAnnotation.class) {
			switch (baseOperationID) {
				case NetannotationsPackage.TEXTUAL_ANNOTATION___GET_ANNOTATION_ATTRIBUTE: return AnnotationsPackage.MARKING___GET_ANNOTATION_ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AnnotationsPackage.MARKING___GET_ANNOTATION_ATTRIBUTE:
