...
public class YawlnetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case YawlnetPackage.PLACE: {
				...
				if (result == null) result = casePnmlcoremodel_Node(place);
			...
			case YawlnetPackage.TRANSITION: {
				...
				if (result == null) result = casePnmlcoremodel_Node(transition);
				if (result == null) result = caseObject(transition);
				if (result == null) result = caseID(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YawlnetPackage.YAWL_NET: {
			...
			case YawlnetPackage.CONTROL_TYPE: {
			...
			case YawlnetPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YawlnetPackage.TOKEN: {
	 ...
	 * @generated
	 */
	public T casePnmlcoremodel_Node(org.pnml.tools.epnk.pnmlcoremodel.Node object) {
		return null;
	}
