...
public class YawlnetAdapterFactory extends AdapterFactoryImpl {
	...
	protected YawlnetSwitch<Adapter> modelSwitch =
		new YawlnetSwitch<Adapter>() {
			...
			@Override
			public Adapter casePnmlcoremodel_Node(org.pnml.tools.epnk.pnmlcoremodel.Node object) {
				return createPnmlcoremodel_NodeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlnet.YAWLNet <em>YAWL Net</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlnet.ControlType <em>Control Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlnet.Node <em>Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlnet.Token <em>Token</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPnmlcoremodel_NodeAdapter() {
		return null;
	}
